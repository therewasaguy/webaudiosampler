...
env = function () {
  ...
  p5.Env.prototype.triggerRelease = function (input, timeFromNow) {
    ...
    // var currentVal =  input.value;
    input.cancelScheduledValues(t);
    input.linearRampToValueAtTime(this.sustainLevel, t + 0.001);
    // release
...
src_app = function () {
  ...
  var p5SOUND = sndcore;
  return p5SOUND;
}(sndcore, master, helpers, soundfile, amplitude, fft, oscillator, pulse, noise, audioin, env, filter, delay, reverb, looper, soundRecorder);
